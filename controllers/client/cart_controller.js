...
module.exports.addPost = async (req, res) => {
    ...
    //hàm find trong JS giúp tìm kiếm điều kiện trong mảng, tác dụng câu lệnh trên là lấy ra phần tử trong mảng đó
    if (existProductInCart) { //nếu sản phẩm đã có trên giả hàng trc đó r thì chỉ cần cập nhật quantity
